...
- [ ] Detect and advertise relay capabilities such as inbound reachability, storage capacity, supported groups, and forwarding availability
  ...
  - [ ] Verify direct reachability from an independent peer before presenting configured endpoints as observed reachable, and distinguish configured forwarding capability from current path availability
