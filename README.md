...
| Placement onto outbound-only volunteers behind NAT, pairwise relationship-mailbox placement, broader churn evaluation, and full resource accounting | Remaining v0.3 work |
...
- **308 automated tests** across core, node, relay, storage, migration, and integration flows
