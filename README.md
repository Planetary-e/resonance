...
| Configured-relay placement, failure-domain preference, signed receipts, persistent repair state, reconnect retry, receipt-scoped batch checks, and publication-state quotas | Implemented v0.3 foundation |
| Graceful handoff, journal compaction, and query forwarding | Remaining v0.3 work |
...
- **270 automated tests** across core, node, relay, storage, migration, and integration flows
