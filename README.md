...
| Journal compaction, bounded query forwarding, publication-mailbox replication, match-notice deduplication, and five-relay churn harness | Implemented v0.3 foundation |
| Pairwise relationship-mailbox placement, desktop background service, and broader churn evaluation | Remaining v0.3 work |
