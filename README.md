...
| Configured-relay placement, signed receipts, persistent repair state, reconnect retry, receipt-scoped batch checks, and publication-state quotas | Implemented v0.3 foundation |
| Peer diversity, graceful handoff, journal compaction, and query forwarding | Remaining v0.3 work |
...
- **267 automated tests** across core, node, relay, storage, migration, and integration flows
